    ...
    def __call__(self, p, targets):  # predictions, targets, model
        ...
        for i, pi in enumerate(p):  # layer index, layer predictions
            ...
            if n:
                ...
                # Objectness target for loss accounting for presence and absence of object
            ...
            # calculate the objectness loss wrt to tobj given the predicted bbox  img, anchor and grid 
